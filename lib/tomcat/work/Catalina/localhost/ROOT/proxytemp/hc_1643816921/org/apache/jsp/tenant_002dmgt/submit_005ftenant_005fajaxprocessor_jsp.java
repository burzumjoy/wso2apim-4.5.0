...
public final class submit_005ftenant_005fajaxprocessor_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//    First remove captcha images first stored in webapps
    ...
    if(tenantId == null && !isDomainAvailable){
      ...
      out.write("             CARBON.showErrorDialog(\"Sorry!. The Domain '");
      out.print(tenantDomain);
      out.write("'is already registered. Please choose a different domain.\");\n");
      out.write("        });\n");
      out.write("    </script>\n");
      out.write("\n");
